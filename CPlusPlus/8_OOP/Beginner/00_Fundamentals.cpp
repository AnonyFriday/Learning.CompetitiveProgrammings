...
// By default, fields are private, we need to set the public
class Product {
 private:
  int id;             // 4 bytes
...
int main() {
  ...
  // Accessing directly the to the property
  // - Quite dangerous since we are interacting directly to the state of the class

  // product.mrp = 100;
  // product.selling_price = 200;
  //
  // cout << sizeof(product) << endl;
  // cout << product.mrp << endl;
  // cout << product.selling_price << endl;
  // cout << product.mrp << endl;

  // Using Getter and Setter
  product.setMrp(20);
  cout << product.getMrp() << endl;
